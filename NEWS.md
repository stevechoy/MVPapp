...
* Fixed an issue where LLM model translation fails for thinking models (#11)

# MVPapp 0.4.1 (2026-03-15)

## Features

* Deterministic translation from NONMEM files using nonmem2mrgsolve and nonmem2rx (#10)
