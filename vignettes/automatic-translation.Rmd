...
To assess the translation accuracy of AI using MVP, a curated list of 20 published models from the literature representing a range of model complexity was used as the reference. Translation performance was evaluated according to the following hierarchical criterion of (generally) increasing difficulty:  
